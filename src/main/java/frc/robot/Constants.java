...
public final class Constants {
  ...
  public static class Arm {
    ...
    private static final double MOTION_SHOULDER_TOLERANCE = 0.005;
    ...
    private static final double POSITION_SHOULDER_kP = 0.1;
    ...
    private static final double POSITION_SHOULDER_TOLERANCE = 0.005;
